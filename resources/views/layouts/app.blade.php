                           ...
                           <li class="dropdown user-dropdown order-sm-first">
                              ...
                              <div class="dropdown-menu dropdown-menu-md dropdown-menu-right dropdown-menu-s1 is-light">
                                 ...
                                 <div class="dropdown-inner">
                                    <ul class="link-list">
                                       <li>
                                          <a href="#"><em class="icon ni ni-signout"></em><span>Cerrar sesión</span></a>
                                       </li>
                                    </ul>
                                 </div>
                              </div>
...
<head>
   <meta charset="utf-8">
   <meta name="author" content="Brayan Angarita - AGENCIA APP">
   <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
   <meta name="description" content="Aplicativo para reservar espacios de espacio público en Medellín - AGENCIA APP">
   <!-- Fav Icon  -->
   <link rel="shortcut icon" href="./images/favicon.png">
   <!-- Page Title  -->
   <title>@yield('title', 'AEEP') - Puntos de aprovechamiento económico</title>
   <!-- StyleSheets  -->
